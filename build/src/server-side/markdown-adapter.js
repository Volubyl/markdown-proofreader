...
exports.getGetContentFromMarkdownFile = void 0;
...
var getCleanContentPipleLine = function () { return highland_1.default.pipeline(highland_1.default.map(stripMarkdown), highland_1.default.map(removeNewLign)); };
var extractContentFromFiles = function (filesPaths) {
    var readFile = highland_1.default.wrapCallback(fs_1.default.readFile);
    return highland_1.default(filesPaths)
        .map(readFile)
...
var getMarkdownFilePathsMatchingGlob = function (glob) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, fast_glob_1.default(sanatizeGlob(glob), {
                ignore: 'node_modules',
            })];
    });
}); };
exports.getGetContentFromMarkdownFile = function (glob) { return __awaiter(void 0, void 0, void 0, function () {
    var filesPaths, contents;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getMarkdownFilePathsMatchingGlob(glob)];
            case 1:
                filesPaths = _a.sent();
                return [4 /*yield*/, extractContentFromFiles(filesPaths)];
            case 2:
                contents = _a.sent();
...
exports.default = exports.getGetContentFromMarkdownFile;
